...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\vi_dictionary on
     Windows, /home/user/dev/vi_dictionary on Linux) in a file named
     dictionary@vi.mozdev.org and copy that file to
